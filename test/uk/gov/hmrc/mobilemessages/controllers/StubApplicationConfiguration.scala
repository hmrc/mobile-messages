...
trait StubApplicationConfiguration {
  ...
  val config = Map[String, Any](
    ...
    "microservice.services.sa-message-renderer.port" -> "8888",
    "microservice.services.ats-message-renderer.host" -> "localhost",
    "microservice.services.ats-message-renderer.port" -> "3333",
    "microservice.services.secure-message-renderer.host" -> "localhost",
    "microservice.services.secure-message-renderer.port" -> "9999",
    "router.regex" -> ".*",
